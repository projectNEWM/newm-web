import { d as defineComponent, a5 as toRefs, f as computed, z as ref, u as unref, o as openBlock, a as createBlock, h as withCtx, e as createBaseVNode, q as createVNode, c as createElementBlock, j as createCommentVNode, a7 as useQuasar, bR as entityGroupList, C as onMounted, n as normalizeClass, b as withModifiers, t as toDisplayString, H as Fragment, I as renderList, aH as QPagination_default, bS as json, bT as deleteReportEntityGroup, bU as addReportEntityGroup, bV as updateReportEntityGroup, bW as updateAllReportEntityGroups, bX as setSelectedEntityGroup, F as withDirectives, J as vShow, bY as selectedEntityGroup, i as createTextVNode, bZ as reportLabelList, b_ as addReportLabel, b$ as deleteReportLabel, ag as walletGroupNameList, c0 as allEntityGroup, c1 as switchWalletGroupToSelectedEntityGroup, D as watch, c2 as isZero, c3 as isLessThanZero, c4 as getAssetName, B as useFormatter, c5 as getAssetIdBech32, c6 as accAssetInfoMap, c7 as fetchAssetInfo, K as networkId, c8 as updateAccountAssetInfoMap, aI as useGuard, c9 as hasLeftOverValue, bg as getTimestampFromSlot, ca as QToggle_default, cb as QBtn_default, cc as QPopupProxy_default, cd as QDate_default, ce as getRandomId, cf as markBalanceRewards, cg as markBalanceAsTaxRelevant, ch as markBalanceAsC, ci as resetBalance, cj as calcFiatValue, ck as markBalanceAsManual, cl as markBalanceAsN, cm as trimAllStrings, cn as isTxHash, co as getMetaData, cp as markBalanceUsingCostBasis, cq as updateBalanceCB, cr as getSlotFromDateId, as as appTimezone, cs as onErrorCaptured, ct as getAllMetaData, cu as isZeroOrGreater, bd as useWalletAccount, cv as getRawData, aG as onUnmounted, cw as isAccountLoadingRawReportingData, cx as isLoadingRawReportingData, cy as loadRawData, a6 as useAppWallet, a8 as SyncState, ab as withKeys, ai as walletGroupMap, cz as getIAppWallet, cA as loadRawDataRewards, cB as saveRawData, cC as clearRawData, cD as addRawData, V as nextTick, cE as sortRawBalanceList, cF as subtract, cG as neg, cH as divide, cI as abs, cJ as isGreaterThanZero, cK as getAssetInfoLight, cL as doLoadMissingAssetInfo, cM as saveMetaData, cN as clearMetaData, cO as ITxBalanceType, cP as getDateIdFromSlot, cQ as addPriceOfDay, cR as combineData, cS as setMetaData, cT as getAllReportData, cU as getCSVADAAmount, cV as getCSVAmount, cW as getCSVAmount2, cX as bigToNum, cY as multiply, cZ as saveReportData, c_ as clearReportData, c$ as createReportData, d0 as getAccountIdListByEntity, d1 as createLedger, d2 as getReports, d3 as doLoadMissingAssetInfoByStringList, d4 as setReportData, x as isSignMode } from "./index.js";
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(filteredList.value, (entityGroup, index) => {
                  ...
                  return openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", {
                      ...
                      onClick: withModifiers(($event) => unref(setSelectedEntityGroup)(entityGroup), ["stop"])
                    }, toDisplayString(entityGroup.comment), 11, _hoisted_11$3),
          ...
          createBaseVNode("div", {
            ...
            assetsFiltered.value.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(assetsFiltered.value, (asset, index) => {
              ...
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_10$2, toDisplayString(unref(getAssetName)(asset.asset.t.a, asset.info, true)), 1),
                spamAssets.value.includes(asset.asset.p + asset.asset.t.a) ? (openBlock(), createElementBlock("div", _hoisted_11$2, [
