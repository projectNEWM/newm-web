...
import { gB as endPoints, L as api, d as defineComponent, cs as onErrorCaptured, o as openBlock, c as createElementBlock, e as createBaseVNode, t as toDisplayString, j as createCommentVNode, q as createVNode, h as withCtx, i as createTextVNode, u as unref, z as ref, f as computed, H as Fragment, I as renderList, a as createBlock, aH as QPagination_default, n as normalizeClass, C as onMounted, D as watch, V as nextTick, gC as isSameArray, aA as renderSlot, B as useFormatter, S as reactive, a7 as useQuasar, K as networkId, gD as getResultsDate, gE as isValidDate, a2 as now, aW as addSignalListener, gF as onTxSubmitted, aG as onUnmounted, aX as removeSignalListener, b as withModifiers, a0 as isMobileApp, bM as isIosApp, bQ as isAndroidApp, ce as getRandomId, ae as useSelectedAccount, gG as generateCatalystKey, bD as getDataSignErrorMsg, bC as ErrorSignData, gH as onBuiltTxVoteReg, g0 as getTxBuiltErrorMsg, fX as ErrorBuildTx, bl as dispatchSignal, gI as doBuildTxVoteReg, eo as getRequestData, ep as ApiRequestType, eq as ErrorSync, er as DEFAULT_ACCOUNT_ID, gJ as getDRepAddressFromKeyHash, gK as getDRepAddressFromKeyHashOld, c2 as isZero, cY as multiply, cH as divide, gL as getCCColdAddressFromKeyHash, gM as getCCColdAddressFromKeyHashOld, gN as getCCHotAddressFromKeyHash, gO as getCCHotAddressFromKeyHashOld, gP as onEpochParamsUpdated, gQ as epochParams, gR as getIAppAccountById, gS as decodeBech32, gT as onBuiltTxVoteDelegation, gU as doBuildTxVoteDelegation, aQ as onNetworkFeaturesUpdated } from "./index.js";
...
const _hoisted_20 = { class: "cc-text-semi-bold" };
const _hoisted_21 = {
  key: 6,
  class: "col-span-12 grid grid-cols-12 cc-gap"
};
const _hoisted_22 = ["selected", "value"];
const _hoisted_23 = { class: "col-span-12 sm:col-span-8 cursor-pointer flex flex-col gap-2" };
const _hoisted_24 = { class: "flex flex-row gap-2" };
const _hoisted_25 = {
  key: 9,
  class: "col-span-12"
};
const _hoisted_26 = { class: "cc-text-semi-bold" };
const _hoisted_27 = { class: "cc-text-semi-bold" };
const _hoisted_28 = {
  key: 10,
  class: "col-span-12 max-w-fit cc-banner-gray cc-p mt-2"
};
const _hoisted_29 = { class: "flex flex-row flex-nowrap cc-gap items-center" };
const _hoisted_30 = { class: "flex flex-col flex-nowrap cc-gap" };
const _hoisted_31 = { class: "flex flex-row flex-nowrap" };
const _hoisted_32 = { class: "cc-text-semi-bold" };
const _hoisted_33 = {
  key: 11,
  class: "col-span-12 grid grid-cols-12 cc-gap-lg"
};
const _hoisted_34 = { class: "col-span-12 cc-rounded cc-shadow cc-bg-light-0 cc-p flex flex-col gap-2" };
const _hoisted_35 = { class: "flex flex-col" };
const _hoisted_36 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_37 = { class: "break-all text-center cc-addr" };
const _hoisted_38 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_39 = { class: "break-all text-center cc-addr" };
const _hoisted_40 = { class: "col-span-12 cc-rounded cc-shadow cc-bg-light-0 cc-p flex flex-col gap-2" };
const _hoisted_41 = { class: "flex flex-col" };
const _hoisted_42 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_43 = { class: "break-all text-center cc-addr" };
const _hoisted_44 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_45 = { class: "break-all text-center cc-addr" };
const _hoisted_46 = { class: "col-span-12 cc-rounded cc-shadow cc-bg-light-0 cc-p flex flex-col gap-2" };
const _hoisted_47 = { class: "flex flex-col" };
const _hoisted_48 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_49 = { class: "break-all text-center cc-addr" };
const _hoisted_50 = { class: "w-full flex flex-row flex-nowrap mt-0.5 items-start pt-0.5 text-xs cc-text-semi-bold cc-gap" };
const _hoisted_51 = { class: "break-all text-center cc-addr" };
const _hoisted_52 = { class: "grow-0 shrink-0 w-full flex flex-row flex-nowrap items-start justify-between border-b cc-p" };
const _hoisted_53 = { class: "flex flex-col cc-text-sz" };
const _hoisted_54 = { class: "p-1" };
const _hoisted_55 = { class: "grow-0 shrink-0 w-full flex flex-row flex-nowrap items-start justify-between border-b cc-p" };
const _hoisted_56 = { class: "flex flex-col cc-text-sz" };
const _hoisted_57 = ["href"];
const _hoisted_58 = { class: "p-1" };
const _hoisted_59 = { class: "grid grid-cols-12 cc-gap p-2 w-full" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const delegationDRepVotePower = computed(() => {
      ...
      const drepStake = ((_a2 = delegationDRepInfo.value) == null ? void 0 : _a2.drepStake) ?? "0";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
          ...
          createBaseVNode("div", _hoisted_2, [
            !delegationDRep.value ? (openBlock(), createElementBlock("div", _hoisted_3, toDisplayString(delegationValue.value), 1)) : (openBlock(), createElementBlock("table", _hoisted_4, [
              createBaseVNode("tbody", null, [
                delegationDRepAddrOld.value ? (openBlock(), createElementBlock("tr", _hoisted_5, [
                  createBaseVNode("td", {
                    colspan: delegationDRepAddrOld.value ? 1 : 2,
                    class: "pr-2 cc-text-semi-bold whitespace-nowrap"
                  }, toDisplayString(unref(t)(`wallet.voting.governance.delegation.current.${delegationDRepAddrOld.value ? "drepOld" : "vote"}`)) + ":", 9, _hoisted_6),
                  delegationDRepAddrOld.value ? (openBlock(), createElementBlock("td", _hoisted_7, [
                  ...
                  createBaseVNode("td", _hoisted_8, [
                    createBaseVNode("div", _hoisted_9, toDisplayString(delegationDRepAddrOld.value), 1),
                ...
                createBaseVNode("tr", _hoisted_10, [
                  createBaseVNode("td", {
                    ...
                    class: "pr-2 cc-text-semi-bold whitespace-nowrap"
                  }, toDisplayString(unref(t)(`wallet.voting.governance.delegation.current.${delegationDRepAddr.value ? "drep" : "vote"}`)) + ":", 9, _hoisted_11),
                  delegationDRepAddr.value ? (openBlock(), createElementBlock("td", _hoisted_12, [
                    createVNode(_sfc_main$n, {
                      "label-hover": unref(t)("wallet.voting.governance.copy.address.hover"),
                      "notification-text": unref(t)("wallet.voting.governance.copy.address.notify"),
                  ...
                  createBaseVNode("td", _hoisted_13, [
                    createBaseVNode("div", _hoisted_14, toDisplayString(delegationValue.value), 1),
                    delegationDRepUtxo.value ? (openBlock(), createBlock(_sfc_main$o, {
                      key: 0,
                      utxo: delegationDRepUtxo.value,
                      "account-id": unref(selectedAccountId),
                ...
                delegationDRepVotePower.value ? (openBlock(), createElementBlock("tr", _hoisted_17, [
                  ...
                  createBaseVNode("td", _hoisted_19, [
                    ...
                    _cache[10] || (_cache[10] = createBaseVNode("div", { class: "ml-1 mr-0.5" }, "(", -1)),
                    createVNode(_sfc_main$d, {
                      "show-fraction": false,
                      amount: delegationDRepInfo.value.drepStake,
                      "balance-always-visible": ""
                    }, null, 8, ["amount"]),
                    _cache[11] || (_cache[11] = createBaseVNode("div", { class: "ml-0.5" }, ")", -1))
                  ])
                ])) : createCommentVNode("", true)
              ])
            ]))
        ...
        ((_d = unref(rewardInfo)) == null ? void 0 : _d.registered) && ((_e = unref(epochParams)) == null ? void 0 : _e.isAtLeastConwayEra) ? (openBlock(), createElementBlock("div", {
          ...
          createVNode(GridSpace, {
            hr: "",
            class: "col-span-12 mt-3 mb-4 sm:mt-2 sm:mb-4"
          }),
          createBaseVNode("i", {
            class: normalizeClass(["mr-2", showDelegation.value ? "mdi mdi-chevron-down" : "mdi mdi-chevron-right"])
          }, null, 2),
          createBaseVNode("span", _hoisted_20, toDisplayString(unref(t)("wallet.voting.governance.delegation.new.label")), 1)
        ], 2)) : createCommentVNode("", true),
        showDelegation.value && unref(epochParams).isAtLeastConwayEra ? (openBlock(), createElementBlock("div", _hoisted_21, [
        ...
        createVNode(GridSpace, {
          hr: "",
          class: "col-span-12 mt-2 mb-1 sm:mt-2 sm:mb-2"
        }),
        _cache[21] || (_cache[21] = createBaseVNode("div", { class: "col-span-12 sm:col-span-4 cursor-pointer flex flex-col gap-2" }, [
          createBaseVNode("span", null, "More info and DRep lists:"),
          ...
          createBaseVNode("li", null, [
            createBaseVNode("a", {
              href: "https://beta.explorer.cardano.org/en/dreps",
              target: "_blank",
              rel: "noopener noreferrer"
            }, "Cardano Explorer")
          ])
        ...
        createBaseVNode("div", _hoisted_23, [
          createVNode(_sfc_main$e, {
            label: "Eternl DRep Committee",
            "do-capitalize": ""
          }),
          createVNode(_sfc_main$f, { text: "Our motivation to register as a DRep stems from a deep commitment to the Cardano ecosystem and a desire to play an active role in its evolution, ensuring its growth aligns with the principles of decentralization, security, and community empowerment." }),
          createVNode(_sfc_main$f, { text: "Please consider delegating your voting power to us." }),
          createBaseVNode("div", _hoisted_24, [
            _cache[12] || (_cache[12] = createBaseVNode("u", null, [
              createBaseVNode("a", {
                href: "https://beta.explorer.cardano.org/en/drep/drep13d6sxkyz6st9h65qqrzd8ukpywhr8swe9f6357qntgjqye0gttd",
                target: "_blank",
                rel: "noopener noreferrer"
              }, toDisplayString("drep13d6sxkyz6st9h65qqrzd8ukpywhr8swe9f6357qntgjqye0gttd"))
            ], -1)),
        ...
        unref(epochParams).isAtLeastConwayEra ? (openBlock(), createElementBlock("div", _hoisted_25, [
          createBaseVNode("div", {
            ...
            createBaseVNode("span", _hoisted_26, toDisplayString(unref(t)("wallet.voting.governance.info.abstain.label")), 1)
          ]),
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("span", _hoisted_27, toDisplayString(unref(t)("wallet.voting.governance.info.noconfidence.label")), 1)
          ]),
        ...
        unref(govToolURL).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_28, [
          createBaseVNode("div", _hoisted_29, [
            _cache[13] || (_cache[13] = createBaseVNode("i", { class: "mdi mdi-information-outline text-xl sm:text-2xl" }, null, -1)),
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("span", _hoisted_32, toDisplayString(unref(t)("wallet.voting.governance.key." + (!showCreds.value ? "show" : "hide"))), 1)
        ]),
        showCreds.value ? (openBlock(), createElementBlock("div", _hoisted_33, [
          createVNode(_sfc_main$g, {
            nopadding: "",
            class: "col-span-12",
            css: "",
          ...
          createBaseVNode("div", _hoisted_34, [
            ...
            createBaseVNode("div", _hoisted_35, [
              createBaseVNode("div", _hoisted_36, [
                ...
                createBaseVNode("div", _hoisted_37, toDisplayString(accDRepAddrOld.value), 1)
              ]),
              createBaseVNode("div", _hoisted_38, [
                ...
                createBaseVNode("div", _hoisted_39, toDisplayString(accDRepAddr.value), 1)
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_40, [
            ...
            createBaseVNode("div", _hoisted_41, [
              createBaseVNode("div", _hoisted_42, [
                ...
                createBaseVNode("div", _hoisted_43, toDisplayString(ccColdAddrOld.value), 1)
              ]),
              createBaseVNode("div", _hoisted_44, [
                ...
                createBaseVNode("div", _hoisted_45, toDisplayString(ccColdAddr.value), 1)
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_46, [
            ...
            createBaseVNode("div", _hoisted_47, [
              createBaseVNode("div", _hoisted_48, [
                ...
                createBaseVNode("div", _hoisted_49, toDisplayString(ccHotAddrOld.value), 1)
              ]),
              createBaseVNode("div", _hoisted_50, [
                _cache[19] || (_cache[19] = createBaseVNode("div", { class: "cc-addr" }, "(CIP129)", -1)),
                createVNode(_sfc_main$n, {
                  "label-hover": unref(t)("wallet.voting.governance.copy.address.hover"),
                  "notification-text": unref(t)("wallet.voting.governance.copy.address.notify"),
                  "copy-text": ccHotAddr.value
                }, null, 8, ["label-hover", "notification-text", "copy-text"]),
                createBaseVNode("div", _hoisted_51, toDisplayString(ccHotAddr.value), 1)
              ])
            ])
          ])
        ])) : createCommentVNode("", true),
