...
import { dl as getAugmentedNamespace, dm as Buffer$1, dn as global, dp as getDefaultExportFromCjs, dq as commonjsRequire$1, dr as requireCryptoBrowserify, ds as process$1, dt as commonjsGlobal, du as BN$9, dv as hash$2, dw as require$$0$4, dx as minimalisticAssert$1, dy as utils$c, dz as inherits_browserExports, dA as hash$3, dB as requireBrorand, dC as hmacDrbg$1, dD as DataError, bS as json, bN as Dexie, aF as getObjRef, z as ref, S as reactive, f as computed, K as networkId, bl as dispatchSignal, dE as doSendUpdateWalletConnectList, aW as addSignalListener, dF as BroadcastMsgType, dG as error, dH as ErrorDB, bd as useWalletAccount, dk as getRewardAddressFromCred, a2 as now, dI as cip30_getRewardAddresses, dJ as cip30_getChangeAddress, dK as cip30_getForcedUnusedAddresses, dL as cip30_getUnusedAddresses, dM as cip30_getUsedAddresses, dN as cip30_getNetworkId, dO as cip30_getUtxos, dP as cip30_getPaginate, dQ as cip30_getAmount, dR as cip30_getCollateral, dS as cip30_getBalance, dT as cip30_submitTx, dU as prepareData, dV as prepareTx, aZ as ErrorSignTx, dW as setApiRequest, ce as getRandomId, dX as METHOD, D as watch$3, dY as onAllConnectionsDisconnected, dZ as onWalletConnectSaved, d_ as onWalletConnectAdded, d$ as useQuasarInternal, e0 as getRandomUUID } from "./index.js";
import { e as eventsExports, a as es } from "./events.js";
...
function createCodec$2(name2, prefix, encode4, decode2) {
  return {
    name: name2,
    prefix,
    encoder: {
...
function decodeJSON(str) {
  return safeJsonParse(toString$2(fromString$1(str, JWT_ENCODING), JSON_ENCODING));
}
...
function decodeJWT(jwt) {
  ...
  const data = fromString$1(params.slice(0, 2).join(JWT_DELIMITER), DATA_ENCODING);
...
function createCodec$1(name2, prefix, encode4, decode2) {
  return {
    name: name2,
    prefix,
    encoder: {
...
function A(e2) {
  return Number(toString$1(e2, ye$3));
}
function gr$2(e2) {
...
function vr$2(e2, n4) {
  const t = Ee$2(M$2), r2 = random.randomBytes(K$2), o3 = fromString(e2, k$1);
...
function br$2(e2) {
  ...
  return toString$1(o3, k$1);
}
function Er$2(e2, n4) {
  const { sealed: t } = Q$1({ encoded: e2, encoding: n4 });
  return toString$1(t, k$1);
}
function we$3(e2) {
  const { encoding: n4 = ge$1 } = e2;
  if (A(e2.type) === M$2) return toString$1(concat([e2.type, e2.sealed]), n4);
  if (A(e2.type) === D$2) {
    if (typeof e2.senderPublicKey > "u") throw new Error("Missing sender public key for type 1 envelope");
    return toString$1(concat([e2.type, e2.senderPublicKey, e2.iv, e2.sealed]), n4);
  }
  return toString$1(concat([e2.type, e2.iv, e2.sealed]), n4);
}
function Q$1(e2) {
...
function wr$2(e2, n4) {
  ...
  return On({ type: A(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString$1(t.senderPublicKey, g$1) : void 0, receiverPublicKey: n4 == null ? void 0 : n4.receiverPublicKey });
}
function On(e2) {
...
function Zr$1(e2, n4) {
  let t = null;
  return b$2(e2 == null ? void 0 : e2.publicKey, false) || (t = S$4("MISSING_OR_INVALID", `${n4} controller public key should be a string`)), t;
}
function Se(e2) {
  let n4 = true;
...
function Xr$1(e2, n4, t) {
  ...
  if (e2 && Z$3(e2)) {
    ...
    const s2 = Fn(e2, n4, t);
    s2 && (r2 = s2);
  } else r2 = S$4("MISSING_OR_INVALID", `${n4}, ${t} should be an object with data`);
  return r2;
}
function Wn(e2, n4) {
  let t = null;
  if (e2 && Z$3(e2)) {
    ...
    const o3 = Bn(e2, n4);
    o3 && (t = o3);
  } else t = S$4("MISSING_OR_INVALID", `${n4}, namespaces should be an object with data`);
  return t;
}
function Jn(e2) {
...
function zn(e2, n4, t) {
  ...
  return d4.length && (r2 = S$4("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
      Required: ${d4.toString()}
      Received: ${Object.keys(n4).toString()}`)), $$2(i3, u2) || (r2 = S$4("NON_CONFORMING_NAMESPACES", `${t} namespaces chains don't satisfy required namespaces.
      Required: ${i3.toString()}
      Approved: ${u2.toString()}`)), Object.keys(n4).forEach((a3) => {
    if (!a3.includes(":") || r2) return;
    const f3 = C$1(n4[a3].accounts);
    f3.includes(a3) || (r2 = S$4("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${a3}
        Required: ${a3}
        Approved: ${f3.toString()}`));
  }), i3.forEach((a3) => {
    r2 || ($$2(o3[a3].methods, s2[a3].methods) ? $$2(o3[a3].events, s2[a3].events) || (r2 = S$4("NON_CONFORMING_NAMESPACES", `${t} namespaces events don't satisfy namespace events for ${a3}`)) : r2 = S$4("NON_CONFORMING_NAMESPACES", `${t} namespaces methods don't satisfy namespace methods for ${a3}`));
  }), r2;
}
function lo(e2) {
  const n4 = {};
...
let Gt$1 = class Gt {
  constructor(e2, t) {
    this.core = e2, this.logger = t, this.keychain = /* @__PURE__ */ new Map(), this.name = Ze$1, this.version = Qe, this.initialized = false, this.storagePrefix = x$3, this.init = async () => {
      ...
      if (typeof i3 > "u") {
        const { message: r2 } = S$4("NO_MATCHING_KEY", `${this.name}: ${s2}`);
        throw new Error(r2);
      }
      return i3;
    }, this.del = async (s2) => {
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: e2 } = S$4("NOT_INITIALIZED", this.name);
      throw new Error(e2);
    }
  }
};
...
let Wt$1 = class Wt extends d$1 {
  ...
  async rpcSubscribe(e2, t, s2) {
    var i3;
    (s2 == null ? void 0 : s2.transportType) === M$1.relay && await this.restartToComplete();
    ...
    try {
      ...
      if ((s2 == null ? void 0 : s2.transportType) === M$1.link_mode) return setTimeout(() => {
  ...
  getSubscription(e2) {
    ...
    if (!t) {
      const { message: s2 } = S$4("NO_MATCHING_KEY", `${this.name}: ${e2}`);
      throw new Error(s2);
    }
    return t;
  }
  ...
  async restore() {
    try {
      ...
      if (this.subscriptions.size) {
        const { message: t } = S$4("RESTORE_WILL_OVERRIDE", this.name);
...
class ti extends u {
  ...
  async publish(e2, t, s2) {
    this.isInitialized(), await this.publisher.publish(e2, t, s2), await this.recordMessageEvent({ topic: e2, message: t, publishedAt: Date.now(), transportType: M$1.relay });
  }
  ...
  async onProviderPayload(e2) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e2 }), isJsonRpcRequest(e2)) {
      ...
      const t = e2.params, { topic: s2, message: i3, publishedAt: r2, attestation: n4 } = t.data, a3 = { topic: s2, message: i3, publishedAt: r2, transportType: M$1.relay, attestation: n4 };
  ...
  getData(e2) {
    ...
    if (!t) {
      if (this.recentlyDeleted.includes(e2)) {
        const { message: i3 } = S$4("MISSING_OR_INVALID", `Record was recently deleted - ${this.name}: ${e2}`);
...
class oi {
  constructor(e2, t) {
    this.core = e2, this.logger = t, this.name = gt$2, this.version = yt$2, this.events = new es(), this.initialized = false, this.storagePrefix = x$3, this.ignoredPayloadTypes = [D$2], this.registeredMethods = [], this.init = async () => {
      ...
      var r2;
      if (!to(s2)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `pair() params: ${s2}`);
        throw i3.setError($$1.malformed_pairing_uri), new Error(a3);
      }
      if (!Gr$1(s2.uri)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `pair() uri: ${s2.uri}`);
        throw i3.setError($$1.malformed_pairing_uri), new Error(a3);
      }
      const n4 = kr$1(s2 == null ? void 0 : s2.uri);
      if (!((r2 = n4 == null ? void 0 : n4.relay) != null && r2.protocol)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", "pair() uri#relay-protocol");
        throw i3.setError($$1.malformed_pairing_uri), new Error(a3);
      }
      if (!(n4 != null && n4.symKey)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", "pair() uri#symKey");
        throw i3.setError($$1.malformed_pairing_uri), new Error(a3);
      }
      if (n4 != null && n4.expiryTimestamp && cjs$3.toMiliseconds(n4 == null ? void 0 : n4.expiryTimestamp) < Date.now()) {
        ...
        const { message: a3 } = S$4("EXPIRED", "pair() URI has expired. Please try again with a new connection URI.");
        throw new Error(a3);
      }
    }, this.isValidPing = async (s2) => {
      if (!to(s2)) {
        const { message: r2 } = S$4("MISSING_OR_INVALID", `ping() params: ${s2}`);
        throw new Error(r2);
      }
      const { topic: i3 } = s2;
      ...
      if (!to(s2)) {
        const { message: r2 } = S$4("MISSING_OR_INVALID", `disconnect() params: ${s2}`);
        throw new Error(r2);
      }
      const { topic: i3 } = s2;
      await this.isValidPairingTopic(i3);
      ...
      if (!b$2(s2, false)) {
        const { message: i3 } = S$4("MISSING_OR_INVALID", `pairing topic should be a string: ${s2}`);
        throw new Error(i3);
      }
      if (!this.pairings.keys.includes(s2)) {
        const { message: i3 } = S$4("NO_MATCHING_KEY", `pairing topic doesn't exist: ${s2}`);
        throw new Error(i3);
      }
      if (Kt$2(this.pairings.get(s2).expiry)) {
        await this.deletePairing(s2);
        const { message: i3 } = S$4("EXPIRED", `pairing topic: ${s2}`);
        throw new Error(i3);
      }
  ...
  registerRelayerEvents() {
    this.core.relayer.on(v$2.message, async (e2) => {
      ...
      if (!this.pairings.keys.includes(t) || i3 === M$1.link_mode || this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(s2))) return;
  ...
  registerExpirerEvents() {
    this.core.expirer.on(S$2.expired, async (e2) => {
...
class hi extends x$4 {
  constructor(e2, t) {
    super(e2, t), this.core = e2, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new eventsExports.EventEmitter(), this.name = bt$1, this.version = ft$1, this.cached = [], this.initialized = false, this.storagePrefix = x$3, this.init = async () => {
      ...
      this.expirations.set(r2, n4), this.checkExpiry(r2, n4), this.events.emit(S$2.created, { target: r2, expiration: n4 });
    }, this.get = (s2) => {
      this.isInitialized();
      const i3 = this.formatTarget(s2);
      ...
      if (this.isInitialized(), this.has(s2)) {
        ...
        this.expirations.delete(i3), this.events.emit(S$2.deleted, { target: i3, expiration: r2 });
      }
    }, this.on = (s2, i3) => {
      this.events.on(s2, i3);
    }, this.once = (s2, i3) => {
  ...
  formatTarget(e2) {
    ...
    const { message: t } = S$4("UNKNOWN_TYPE", `Target type: ${typeof e2}`);
    throw new Error(t);
  }
  ...
  expire(e2, t) {
    this.expirations.delete(e2), this.events.emit(S$2.expired, { target: e2, expiration: t });
  }
  checkExpirations() {
    this.core.relayer.connected && this.expirations.forEach((e2, t) => this.checkExpiry(t, e2));
  }
  registerEventListeners() {
    this.core.heartbeat.on(r$1.pulse, () => this.checkExpirations()), this.events.on(S$2.created, (e2) => {
      const t = S$2.created;
      this.logger.info(`Emitting ${t}`), this.logger.debug({ type: "event", event: t, data: e2 }), this.persist();
    }), this.events.on(S$2.expired, (e2) => {
      const t = S$2.expired;
      this.logger.info(`Emitting ${t}`), this.logger.debug({ type: "event", event: t, data: e2 }), this.persist();
    }), this.events.on(S$2.deleted, (e2) => {
      const t = S$2.deleted;
      this.logger.info(`Emitting ${t}`), this.logger.debug({ type: "event", event: t, data: e2 }), this.persist();
    });
  }
...
let ne$2 = class ne extends n$1 {
  constructor(e2) {
    ...
    super(e2), this.protocol = ye$2, this.version = De$1, this.name = ie$2, this.events = new eventsExports.EventEmitter(), this.initialized = false, this.on = (n4, a3) => this.events.on(n4, a3), this.once = (n4, a3) => this.events.once(n4, a3), this.off = (n4, a3) => this.events.off(n4, a3), this.removeListener = (n4, a3) => this.events.removeListener(n4, a3), this.dispatchEnvelope = ({ topic: n4, message: a3, sessionExists: h4 }) => {
      if (!n4 || !a3) return;
      const c2 = { topic: n4, message: a3, publishedAt: Date.now(), transportType: M$1.link_mode };
...
function nt$1(r2) {
  ...
  if (s2 && !po(s2, U$1)) {
    const { message: o3 } = S$4("MISSING_OR_INVALID", `request() expiry: ${s2}. Expiry must be a number (in seconds) between ${U$1.min} and ${U$1.max}`);
    throw new Error(o3);
  }
  return !!(t && e2 && i3 && n4);
}
...
const De = (r2, t, e2 = 0) => (ae$1.encode(r2, t, e2), t), ce = (r2) => ae$1.encodingLength(r2), M2 = (r2, t) => {
...
class wr {
  ...
  digest(t) {
    if (t instanceof Uint8Array) {
      ...
      return e2 instanceof Uint8Array ? M2(this.code, e2) : e2.then((i3) => M2(this.code, i3));
    } else throw Error("Unknown type, must be binary type");
  }
}
...
const de = 0, Ar = "identity", pe = re, _r = (r2) => M2(de, pe(r2)), xr = { code: de, name: Ar, encode: pe, digest: _r };
...
class Rs extends M$3 {
  constructor(o3) {
    super(o3), this.name = nt, this.events = new es(), this.initialized = false, this.requestQueue = { state: x$1.idle, queue: [] }, this.sessionRequestQueue = { state: x$1.idle, queue: [] }, this.requestQueueDelay = cjs$3.ONE_SECOND, this.expectedPairingMethodMap = /* @__PURE__ */ new Map(), this.recentlyDeletedMap = /* @__PURE__ */ new Map(), this.recentlyDeletedLimit = 200, this.relayMessageCache = [], this.init = async () => {
      ...
      if (!c2) {
        const { message: E2 } = S$4("NO_MATCHING_KEY", `connect() pairing topic: ${c2}`);
        throw new Error(E2);
      }
      ...
      this.events.once(Lt$2("session_connect"), async ({ error: E2, session: S5 }) => {
        if (E2) y3(E2);
          ...
          const M3 = D$1(I({}, S5), { pairingTopic: m2.pairingTopic, requiredNamespaces: m2.requiredNamespaces, optionalNamespaces: m2.optionalNamespaces, transportType: M$1.relay });
          await this.client.session.set(S5.topic, M3), await this.setExpiry(S5.topic, S5.expiry), c2 && await this.client.core.pairing.updateMetadata({ topic: c2, metadata: S5.peer.metadata }), this.cleanupDuplicatePairings(M3), _3(M3);
        }
      });
      ...
      const R3 = await this.client.core.crypto.generateKeyPair(), V2 = w2.publicKey, E2 = await this.client.core.crypto.generateSharedKey(R3, V2), S5 = I(I({ relay: { protocol: a3 ?? "irn" }, namespaces: c2, controller: { publicKey: R3, metadata: this.client.metadata }, expiry: Mt$2(z$1) }, h4 && { sessionProperties: h4 }), p3 && { sessionConfig: p3 }), M3 = M$1.relay;
      ...
      const W2 = D$1(I({}, S5), { topic: E2, requiredNamespaces: m2, optionalNamespaces: y3, pairingTopic: l2, acknowledged: false, self: S5.controller, peer: { publicKey: w2.publicKey, metadata: w2.metadata }, controller: R3, transportType: M$1.relay });
      ...
      (n4 == null ? void 0 : n4.transportType) === M$1.relay && await this.confirmOnlineStateOrThrow();
      ...
      r2.transportType === M$1.relay && await this.confirmOnlineStateOrThrow();
      ...
      if (this.client.session.keys.includes(t)) await this.sendRequest({ topic: t, method: "wc_sessionDelete", params: U$2("USER_DISCONNECTED"), throwOnFailedPublish: true }), await this.deleteSession({ topic: t, emitEvent: false });
        ...
        const { message: s2 } = S$4("MISMATCHED_TOPIC", `Session or pairing topic not found: ${t}`);
        throw new Error(s2);
      }
      ...
      const i3 = t && this.client.core.linkModeSupportedApps.includes(t) && ((s2 = this.client.metadata.redirect) == null ? void 0 : s2.linkMode), r2 = i3 ? M$1.link_mode : M$1.relay;
      r2 === M$1.relay && await this.confirmOnlineStateOrThrow();
      ...
      const M3 = y3 && y3 > v$1.wc_sessionAuthenticate.req.ttl ? y3 : v$1.wc_sessionAuthenticate.req.ttl, W2 = { authPayload: { type: d4 ?? "caip122", chains: n4, statement: a3, aud: c2, domain: h4, version: "1", nonce: p3, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: l2, nbf: w2, resources: _3 }, requester: { publicKey: E2, metadata: this.client.metadata }, expiryTimestamp: Mt$2(M3) }, N2 = { eip155: { chains: n4, methods: [.../* @__PURE__ */ new Set(["personal_sign", ...m2])], events: ["chainChanged", "accountsChanged"] } }, De2 = { requiredNamespaces: {}, optionalNamespaces: N2, relays: [{ protocol: "irn" }], pairingTopic: R3, proposer: { publicKey: E2, metadata: this.client.metadata }, expiryTimestamp: Mt$2(v$1.wc_sessionPropose.req.ttl) }, { done: wt2, resolve: Ve, reject: Ee2 } = _t$2(M3, "Request expired"), ce2 = async ({ error: O3, session: T2 }) => {
      ...
      try {
        if (i3) {
          ...
          const T2 = await this.client.core.crypto.encode("", O3, { type: M$2, encoding: lr$2 });
          Se2 = xr$2(t, R3, T2);
      ...
      const n4 = r2.transportType || M$1.relay;
      n4 === M$1.relay && await this.confirmOnlineStateOrThrow();
      ...
      for (const y3 of s2) {
        ...
        if (R3) {
          const S5 = ar$2(R3), M3 = ur$2(R3);
          d4.push(...S5), V2.push(...M3);
        }
      ...
      i3.transportType === M$1.relay && await this.confirmOnlineStateOrThrow();
      ...
      const { request: s2, pairingTopic: i3, transportType: r2 = M$1.relay } = t;
      ...
      const { topic: t } = e2, { message: s2 } = S$4("MISSING_OR_INVALID", `Decoded payload on topic ${t} is not identifiable as a JSON-RPC request or a response.`);
      throw new Error(s2);
      ...
      try {
        ...
        const { relay: r2, controller: n4, expiry: a3, namespaces: c2, sessionProperties: h4, sessionConfig: p3 } = t.params, d4 = D$1(I(I({ topic: e2, relay: r2, expiry: a3, namespaces: c2, acknowledged: true, pairingTopic: "", requiredNamespaces: {}, optionalNamespaces: {}, controller: n4.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: n4.publicKey, metadata: n4.metadata } }, h4 && { sessionProperties: h4 }), p3 && { sessionConfig: p3 }), { transportType: M$1.relay }), l2 = Lt$2("session_connect");
      ...
      try {
        ...
        await this.setPendingSessionRequest(m2), h4 === M$1.link_mode && (t = l2.peer.metadata.redirect) != null && t.universal && this.client.core.addLinkModeSupportedApp((s2 = l2.peer.metadata.redirect) == null ? void 0 : s2.universal), (i3 = this.client.signConfig) != null && i3.disableRequestQueue ? this.emitSessionRequest(m2) : (this.addSessionRequestToSessionRequestQueue(m2), this.processSessionRequestQueue());
      } catch (l2) {
      ...
      try {
        ...
        await this.setAuthRequest(i3.id, { request: l2, pairingTopic: s2, transportType: a3 }), a3 === M$1.link_mode && (t = c2.metadata.redirect) != null && t.universal && this.client.core.addLinkModeSupportedApp(c2.metadata.redirect.universal), this.client.events.emit("session_authenticate", { topic: s2, params: i3.params, id: i3.id, verifyContext: d4 });
      } catch (c2) {
      ...
      if (!to(e2)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `connect() params: ${JSON.stringify(e2)}`);
        throw new Error(a3);
      }
      ...
      if (I$3(t) || await this.isValidPairingTopic(t), !eo(n4)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `connect() relays: ${n4}`);
        throw new Error(a3);
      }
      ...
      if (!to(e2)) throw new Error(S$4("MISSING_OR_INVALID", `approve() params: ${e2}`).message);
      ...
      if (!b$2(i3, true)) {
        const { message: h4 } = S$4("MISSING_OR_INVALID", `approve() relayProtocol: ${i3}`);
        throw new Error(h4);
      }
      I$3(r2) || this.validateSessionProps(r2, "sessionProperties");
    }, this.isValidReject = async (e2) => {
      if (!to(e2)) {
        const { message: i3 } = S$4("MISSING_OR_INVALID", `reject() params: ${e2}`);
        throw new Error(i3);
      }
      const { id: t, reason: s2 } = e2;
      if (this.checkRecentlyDeleted(t), await this.isValidProposalId(t), !ro(s2)) {
        const { message: i3 } = S$4("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(s2)}`);
        throw new Error(i3);
      }
    }, this.isValidSessionSettleRequest = (e2) => {
      if (!to(e2)) {
        const { message: c2 } = S$4("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${e2}`);
        throw new Error(c2);
      }
      const { relay: t, controller: s2, namespaces: i3, expiry: r2 } = e2;
      if (!Jn(t)) {
        const { message: c2 } = S$4("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
        throw new Error(c2);
      }
      ...
      if (a3) throw new Error(a3.message);
      if (Kt$2(r2)) {
        const { message: c2 } = S$4("EXPIRED", "onSessionSettleRequest()");
        throw new Error(c2);
      }
    }, this.isValidUpdate = async (e2) => {
      if (!to(e2)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `update() params: ${e2}`);
        throw new Error(a3);
      }
      ...
      if (!to(e2)) {
        const { message: s2 } = S$4("MISSING_OR_INVALID", `extend() params: ${e2}`);
        throw new Error(s2);
      }
      const { topic: t } = e2;
      this.checkRecentlyDeleted(t), await this.isValidSessionTopic(t);
      ...
      if (!to(e2)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `request() params: ${e2}`);
        throw new Error(a3);
      }
      ...
      if (!co(n4, i3)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `request() chainId: ${i3}`);
        throw new Error(a3);
      }
      if (!oo(s2)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `request() ${JSON.stringify(s2)}`);
        throw new Error(a3);
      }
      if (!ao(n4, i3, s2.method)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `request() method: ${s2.method}`);
        throw new Error(a3);
      }
      if (r2 && !po(r2, me)) {
        const { message: a3 } = S$4("MISSING_OR_INVALID", `request() expiry: ${r2}. Expiry must be a number (in seconds) between ${me.min} and ${me.max}`);
        throw new Error(a3);
      }
    }, this.isValidRespond = async (e2) => {
      var t;
      if (!to(e2)) {
        const { message: r2 } = S$4("MISSING_OR_INVALID", `respond() params: ${e2}`);
        throw new Error(r2);
      }
      ...
      if (!so(i3)) {
        const { message: r2 } = S$4("MISSING_OR_INVALID", `respond() response: ${JSON.stringify(i3)}`);
        throw new Error(r2);
      }
    }, this.isValidPing = async (e2) => {
      if (!to(e2)) {
        const { message: s2 } = S$4("MISSING_OR_INVALID", `ping() params: ${e2}`);
        throw new Error(s2);
      }
      const { topic: t } = e2;
      ...
      if (!to(e2)) {
        const { message: n4 } = S$4("MISSING_OR_INVALID", `emit() params: ${e2}`);
        throw new Error(n4);
      }
      ...
      if (!co(r2, i3)) {
        const { message: n4 } = S$4("MISSING_OR_INVALID", `emit() chainId: ${i3}`);
        throw new Error(n4);
      }
      if (!io(s2)) {
        const { message: n4 } = S$4("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(s2)}`);
        throw new Error(n4);
      }
      if (!uo(r2, i3, s2.name)) {
        const { message: n4 } = S$4("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(s2)}`);
      ...
      if (!to(e2)) {
        const { message: s2 } = S$4("MISSING_OR_INVALID", `disconnect() params: ${e2}`);
        throw new Error(s2);
      }
      const { topic: t } = e2;
      await this.isValidSessionOrPairingTopic(t);
      ...
      Object.values(e2).forEach((s2) => {
        if (!b$2(s2, false)) {
          const { message: i3 } = S$4("MISSING_OR_INVALID", `${t} must be in Record<string, string> format. Received: ${JSON.stringify(s2)}`);
          throw new Error(i3);
        }
      });
      ...
      i3 && this.client.session.update(t, { transportType: M$1.link_mode }), this.client.core.dispatchEnvelope({ topic: t, message: s2, sessionExists: i3 });
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: o3 } = S$4("NOT_INITIALIZED", this.name);
      throw new Error(o3);
    }
  }
  async confirmOnlineStateOrThrow() {
  ...
  async onRelayMessage(o3) {
    const { topic: e2, message: t, attestation: s2, transportType: i3 } = o3, { publicKey: r2 } = this.client.auth.authKeys.keys.includes(ae) ? this.client.auth.authKeys.get(ae) : { responseTopic: void 0, publicKey: void 0 }, n4 = await this.client.core.crypto.decode(e2, t, { receiverPublicKey: r2, encoding: i3 === M$1.link_mode ? lr$2 : ge$1 });
    try {
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(S$2.expired, async (o3) => {
      const { topic: e2, id: t } = Vt$2(o3.target);
      if (t && this.client.pendingRequest.keys.includes(t)) return await this.deletePendingSessionRequest(t, S$4("EXPIRED"), true);
      if (t && this.client.auth.requests.keys.includes(t)) return await this.deletePendingAuthRequest(t, S$4("EXPIRED"), true);
  ...
  isValidPairingTopic(o3) {
    if (!b$2(o3, false)) {
      const { message: e2 } = S$4("MISSING_OR_INVALID", `pairing topic should be a string: ${o3}`);
      throw new Error(e2);
    }
    if (!this.client.core.pairing.pairings.keys.includes(o3)) {
      const { message: e2 } = S$4("NO_MATCHING_KEY", `pairing topic doesn't exist: ${o3}`);
      throw new Error(e2);
    }
    if (Kt$2(this.client.core.pairing.pairings.get(o3).expiry)) {
      const { message: e2 } = S$4("EXPIRED", `pairing topic: ${o3}`);
      throw new Error(e2);
    }
  }
  async isValidSessionTopic(o3) {
    if (!b$2(o3, false)) {
      const { message: e2 } = S$4("MISSING_OR_INVALID", `session topic should be a string: ${o3}`);
      throw new Error(e2);
    }
    if (this.checkRecentlyDeleted(o3), !this.client.session.keys.includes(o3)) {
      const { message: e2 } = S$4("NO_MATCHING_KEY", `session topic doesn't exist: ${o3}`);
      throw new Error(e2);
    }
    if (Kt$2(this.client.session.get(o3).expiry)) {
      await this.deleteSession({ topic: o3 });
      const { message: e2 } = S$4("EXPIRED", `session topic: ${o3}`);
      throw new Error(e2);
    }
    if (!this.client.core.crypto.keychain.has(o3)) {
      const { message: e2 } = S$4("MISSING_OR_INVALID", `session topic does not exist in keychain: ${o3}`);
  ...
  async isValidSessionOrPairingTopic(o3) {
    if (this.checkRecentlyDeleted(o3), this.client.session.keys.includes(o3)) await this.isValidSessionTopic(o3);
      ...
      const { message: e2 } = S$4("NO_MATCHING_KEY", `session or pairing topic doesn't exist: ${o3}`);
      throw new Error(e2);
    } else {
      const { message: e2 } = S$4("MISSING_OR_INVALID", `session or pairing topic should be a string: ${o3}`);
      throw new Error(e2);
    }
  }
  async isValidProposalId(o3) {
    if (!no(o3)) {
      const { message: e2 } = S$4("MISSING_OR_INVALID", `proposal id should be a number: ${o3}`);
      throw new Error(e2);
    }
    if (!this.client.proposal.keys.includes(o3)) {
      const { message: e2 } = S$4("NO_MATCHING_KEY", `proposal id doesn't exist: ${o3}`);
      throw new Error(e2);
    }
    if (Kt$2(this.client.proposal.get(o3).expiryTimestamp)) {
      await this.deleteProposal(o3);
      const { message: e2 } = S$4("EXPIRED", `proposal id: ${o3}`);
      throw new Error(e2);
    }
  }
}
...
o2.prototype.getMaxListeners = function() {
  ...
  else for (var d4 = u2.length, M3 = O2(u2, d4), n4 = 0; n4 < d4; ++n4) y2(M3[n4], this, e2);
  return true;
};
