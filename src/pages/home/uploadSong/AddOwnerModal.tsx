  ...
  return (
    ...
    >
      <Box
        ...
        <TextInputField label="Email"name="Email" placeholder="john.smith@gmail.com" />
        ...
        <Stack sx={ {
          ...
          <Stack>
            ...
            <Typography fontSize={ 12 } variant="subtitle1">Enable to show this person in the credits.</Typography>
          </Stack>
